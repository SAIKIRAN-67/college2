...
const AdmissionModule = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        caste: "",
        category: "",
        physicallychallenged: "Physically Handicapped",
        castecertificatenumber: "",
        incomecertificatenumber: "",
        ewsnumber: "",
        ricecardnumber: "",
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <div className="row mb-3">
                        <div className="col">
                            <label for="secondLanguage"><h6 className='p-2'>Second Language Preferred</h6></label>
                            <select className="form-select" aria-label="Second Language Preferred" placeholder="Second Language Preferred" id="secondlanguage" onChange={handleChange} required>
                                <option value="sanskrit" selected>Sanskrit</option>
                                <option value="telugu">Telugu</option>
                                <option value="hindi">Hindi</option>
                                <option value="urdu">Urdu</option>
                        ...
                        <div className='col'>
                            <label for="degreeGroupChosen"><h6 className='p-2'>Degree Group Chosen</h6></label>
                            <select className="form-select" aria-label="Degree Group Chosen" placeholder="Degree Group Chosen" id="group" onChange={handleChange} required>
                        ...
                        <div className='col'>
                            ...
                            <select className="form-select" aria-label="Degree Group Chosen Majors" placeholder="Degree Group Chosen Majors" id="majors" onChange={handleChange} required>
                                <option value="Physics" >Physics</option>
                                <option value="Electronics">Electronics</option>
                                <option value="Statistics" >Statistics</option>
                                <option value="Internet Of Things" selected>Internet Of Things</option>
                        ...
                        <div className='col'>
                            ...
                            <select className="form-select" aria-label="Degree Group Chosen Minors" placeholder="Degree Group Chosen Minors" id="minors" onChange={handleChange} required>
                                <option value="Physics" >Physics</option>
